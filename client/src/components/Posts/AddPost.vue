      ...
      <!-- Title Input -->
        <v-layout row>
          <v-flex xs12>
            ...
            label="Post Title" type="text" required>
            </v-text-field>
          </v-flex>
        </v-layout>
        ...
        <!-- Image url Input -->
          <v-layout row>
            <v-flex xs12>
              ...
              label="Image URL" type="text" required>
              </v-text-field>
           </v-flex>
          </v-layout>
        ...
        <!-- Categories Select -->
          <v-layout row>
            <v-flex xs12>
              ...
              :items="['Art', 'Technology', 'Travel', 'Food']" multiple label="Categories"
        ...
        <!-- Description Text Area -->
          <v-layout row>
            <v-flex xs12>
              ...
              label="Description" type="text" required>
              </v-textarea>
           </v-flex>
          </v-layout>
          ...
          <v-layout row>
            <v-flex xs12>
              <v-btn :disabled="!isFormValid || loading" color="info" type="submit">Submit</v-btn>
            </v-flex>
          </v-layout>
